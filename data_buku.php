...
$buku = query("SELECT * FROM buku ORDER BY no_buku ASC");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Data Buku | Perpustakaan Jembatan Ilmu</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
                <a href="addData.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Buku</a>
            </div>
        </div>
        <div class="row my-3">
            <div class="col-md">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($buku as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['kategori']; ?></td>
                                <td>
                                    <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['isbn']; ?>" style="font-weight: 600;"><i class="bi bi-info-circle-fill"></i>&nbsp;Detail</button> 

                                    <a href="ubah.php?isbn=<?= $row['isbn']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> 

                                    <a href="hapus.php?isbn=<?= $row['isbn']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_buku']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a> 
