  ...
  <body>
    ...
    <div class="container">
      <nav class="row navbar navbar-expand-lg navbar-light bg-white">
        ...
        <a class="navbar-brand" href="index_2.php"><h2>PJL</h2></a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navb">
          <ul class="navbar-nav ml-auto mr-3">
            <li class="nav-item mx-md-2">
              <a class="nav-link active" href="index_2.php">Home</a>
            </li>
            <li class="nav-item mx-md-2">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              ...
              >
                ...
                <div class="travel-button mt-auto">
                  <a href="data_buku.php" class="btn btn-travel-details px-4" style="background-color:#ffaa57; color:fff;">
                    View More
                  </a>
                </div>
