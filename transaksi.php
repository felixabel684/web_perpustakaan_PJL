...
$transaksi = query("SELECT * FROM tb_transaksi INNER JOIN buku
										...
										ON tb_transaksi.nim = tb_anggota.nim WHERE status = 'pinjam'
										");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Peminjaman Buku | Perpustakaan Jembatan Ilmu</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Peminjaman Buku</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <a href="transaksi_addData.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Peminjaman</a>
                <a href="transaksi_laporan.php" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Laporan Peminjaman</a>
              </div>
        </div>
        <div class="row my-3">
            <div class="col-md">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($transaksi as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['status']; ?></td>
                                <td>
                                     <a href="transaksi_kembali.php?id=<?= $row['id_transaksi']; ?>&nama_buku=<?= $row['nama_buku']; ?>" class="btn btn-info btn-sm">Kembalikan</a>
                                    
                                     <a href="transaksi_perpanjang.php?id=<?= $row['id_transaksi']; ?>&judul=<?= $row['nama_buku']; ?>&lambat=<?= $lambat ?>&tgl_kembali=<?= $row['tgl_kembali']; ?>" class="btn btn-success btn-sm">Perpanjang</a>
